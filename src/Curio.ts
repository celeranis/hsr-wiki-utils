...
import { InternalCurio, InternalCurioDisplay, InternalIndexCurio, InternalUNDCurio } from './files/Curio.js'
...
export class Curio {
	...
	constructor(public id: number, public is_du: boolean) {
		...
		const display = (is_du ? RogueTournMiracleDisplay : RogueMiracleDisplay)[curio.MiracleDisplayID] ?? RogueTournMiracleDisplay[curio.MiracleDisplayID]
		...
		this.effect = textMap.getText(curio.MiracleDesc, curio.DescParamList) || textMap.getText(display.MiracleDesc, display.DescParamList)
